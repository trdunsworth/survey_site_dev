...
export const saveResponse = async (submissionId, questionId, answer) => {
    ...
    db.data.answers = db.data.answers.filter(a => !(a.submission_id === submissionId && a.question_id === questionId));
    // Add new answer
...
export const getAllSubmissions = async () => {
    await db.read();
    return db.data.submissions.sort((a, b) => new Date(b.created_at).getTime() - new Date(a.created_at).getTime());
};
export default db;
